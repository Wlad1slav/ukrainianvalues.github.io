...
questions = [
    ...
    {
        "question": "Міграційна політика країн Заходу є неприйнятною для України",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": -7,     // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    {
        "question": "Реклама, телебачення, кіно, тощо повинно буди на українській мові",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": 0,      // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    {
        "question": "Замороження конфлікту на сьогоднішньої лінії розмежування є прийнятною умовою для закінчення війни",
        "effect": {
            "econ": 5,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": 0,      // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
