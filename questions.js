...
questions = [
    ...
    {
        "question": "Жорстокий характер мобілізації є необхідною мірою",
        "effect": {
    ...
    {
        "question": "Для критики влади та політичних дебатів є мирні часи",
        "effect": {
            "econ": -5,     // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": 0,      // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    // },
    {
        "question": "Ліберальна російська опозиція наш союзник",
        "effect": {
    ...
    {
        "question": "Гарних росіян не існує",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
    ...
    {
        "question": "Політика єдиної державної мови приносить більше проблем ніж користі",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": 0,      // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    {
        "question": "Мовний закон порушує права громадян",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": 0,      // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    {   // Більшість українців переоцінюють Європейський Союз
        // Очікування українців від вступу до Європейського Союзу перебільшені й занадто оптимістичні
        "question": "Українці зазвичай переоцінюють користь для України від вступу до Європейського Союзу",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
    ...
    {
        "question": "Спроби укріплення власної армії є більш надійним захистом для України, ніж спроби вступу до НАТО",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
    ...
    // {
    //     "question": "Російська література є частиною російської експансії",
    //     "effect": {
    //         "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
    //         "dipl": -5,     // ВПЛИВ        (русофілія/українство)
    //         "govt": -1,     // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    {
        "question": "Не бачу проблеми в існуванні приватних російськомовних шкіл",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": 0,      // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    {
        "question": "Захід порушив обіцянки перед Україною, не надаючи достатньої кількості зброї",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": -5,     // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    // },
    {
        "question": "Російська культура належить не тільки Росії, але і Україні",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 7,      // ВПЛИВ        (русофілія/українство)
            "govt": 0,      // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    {
        "question": "Україна повинна змусити військовозобов'язаних чоловіків, які втекли з України, повернутися",
        "effect": {
            "econ": -7,     // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": -1,     // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    {
        "question": "Не можна скидати всі проблеми України на президента та його команду",
        "effect": {
            "econ": -7,     // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": 0,      // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    {
        "question": "Санкції західних країн проти звичайних росіян є несправедливими",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 6,      // ВПЛИВ        (русофілія/українство)
            "govt": 0,      // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
            "scty": 0       // МОВА         (немає різниці/державна)
        },
    },
    {
        "question": "Ми можемо покластися на США та ЄС після закінчення війни",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": 5,      // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    // },
    // {
    //     "question": "Мігранти повинні вчити мову держави, в яку вони мігрують",
    //     "effect": {
    //         "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
    //         "dipl": 0,      // ВПЛИВ        (русофілія/українство)
    //         "govt": -5,     // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    {
        "question": "Україні не підходить парламентаризм",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": -9,    // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    {
        "question": "Військові підрозділи РДК, ЛСР, ...  це тільки тимчасові союзники для України",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": -5,     // ВПЛИВ        (русофілія/українство)
            "govt": 0,      // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
